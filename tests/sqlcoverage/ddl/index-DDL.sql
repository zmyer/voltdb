...
CREATE INDEX P2_IDX_NUM_TREE ON P2 (ABS(NUM + 10));
CREATE INDEX P2_IDX_RATIO_TREE ON P2 (RATIO / 2);
CREATE INDEX P2_IDX_VCHAR_TREE ON P2 (CONCAT(VCHAR, '10'));
CREATE INDEX P2_IDX_NUM_RATIO_VCHAR_TREE ON P2 (CONCAT(VCHAR, STR(NUM + RATIO)));
...
CREATE INDEX R2_IDX_NUM_TREE ON R2 (ABS(NUM + 10));
CREATE INDEX R2_IDX_RATIO_TREE ON R2 (RATIO / 2);
CREATE INDEX R2_IDX_VCHAR_TREE ON R2 (CONCAT(VCHAR, '10'));
CREATE INDEX R2_IDX_NUM_RATIO_VCHAR_TREE ON R2 (CONCAT(VCHAR, STR(NUM + RATIO)));
