...
public class DRIDTrackerHelper {
     ...
     * @throws JSONException
     */
    public static Map<Integer, Map<Integer, DRSiteDrIdTracker>> dejsonifyClusterTrackers(final String jsonData, boolean resetLastReceived)
    throws JSONException
    {
        ...
        while (clusterIdKeys.hasNext()) {
            ...
            while (srcPidKeys.hasNext()) {
                ...
                final DRSiteDrIdTracker tracker = new DRSiteDrIdTracker(ids, resetLastReceived);
