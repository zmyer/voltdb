...
public class SystemProcedureCatalog {
    ...
    static {                                                                                            // SP     RO     Every  Param ParamType           PRO    killDR skipDR replica-ok durable allowedInShutdown transactional
        ...
        builder.put("@NibbleDeletes",           new Config("org.voltdb.sysprocs.NibbleDeletes",            false, false, false, 0,    VoltType.INVALID,   false, false, false, true,      true,   false,            false ));
        ...
        builder.put("@CancelNTProcedure",       new Config(null,                                           true,  true,  false, 0,    VoltType.INVALID,   false, false, true,  true,      true,   false,            false ));
