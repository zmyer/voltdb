...
public abstract class ExecutionEngine implements FastDeserializer.DeserializationMonitor {
     ...
     * @param version request test DR buffer to generate specific dr protocol version
     ...
     */
    public native static byte[] getTestDRBuffer(int version, int partitionId, int partitionKeyValues[], int flags[],
                                                long startSequenceNumber);

    public static byte[] getTestDRBuffer(int partitionId, int partitionKeyValues[], int flags[],
            long startSequenceNumber) {
